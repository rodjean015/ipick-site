...
export default function Home() {
  return (
    <div>
      ...
      <section id="why-choose" className="bg-[#0D1B2A] py-20 text-center text-white">
        <h2 className="text-3xl font-semibold">Why Choose iPick?</h2>
        <p className="mt-4 p-4 max-w-3xl mx-auto text-gray-300">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 p-6 max-w-6xl mx-auto">
          {/* Card 1 */}
          <div className="bg-[#1B263B] rounded-lg shadow-md p-6 flex flex-col items-center text-center">
